          ...
          await (async () => {
            ...
            if(index === 1){
              ...
              await page1.waitForTimeout(10000);
                ...
                await page1.waitForTimeout(1000);
                let dgf = await page1.$x(`/html/body/div[1]/div[2]/div/div/div/section/div/div[3]/div/entities-page/div/md-tabs/md-tabs-content-wrapper/md-tab-content[1]/div/custom-entities-list/div/ul/li[13]`, {timeout: 15000});
                await page1.waitForTimeout(5000);
                await dgf[0].hover()
            ...
            //     }
                ...
                console.log(e4)
                await page1.waitForTimeout(1000);
                await page1.waitForXPath(`/html/body/div[1]/div[2]/div/div/div/section/div/div[3]/div/entities-page/div/md-tabs/md-tabs-content-wrapper/md-tab-content[1]/div/custom-entities-list/div/ul/li[13]/md-checkbox`, {
                    timeout: 5000
                });
                await page1.waitForTimeout(1000);
                let ell1 = await page1.$x(`/html/body/div[1]/div[2]/div/div/div/section/div/div[3]/div/entities-page/div/md-tabs/md-tabs-content-wrapper/md-tab-content[1]/div/custom-entities-list/div/ul/li[13]/md-checkbox`, {
                    timeout: 5000
                });
                await ell1[0].click();
                }
