...
async function run() {
    ...
    try {
        ...
        // #intent-parameters-table > tbody > tr:nth-child(1)
            ...
            try {
                for(let el = 1; el < 48; el ++) {
                    ...
                    try {
                        ...
                        await page1.waitForSelector('#main > div > div.workplace.ng-scope > div > div > div.ng-scope > ul > li:nth-child(2) > intents-list-item > div > div > span')
                        await page1.click('#main > div > div.workplace.ng-scope > div > div > div.ng-scope > ul > li:nth-child(2) > intents-list-item > div > div > span')
                        
                        // check phoneNumber param val
                        await page1.waitForSelector('#intent-parameters-table > tbody > tr:nth-child(1) > td:nth-child(5) > div > textarea')
                        let phoneNumber = await page1.$eval('#intent-parameters-table > tbody > tr:nth-child(1) > td:nth-child(5) > div > textarea', el => el.value)
                        console.log(phoneNumber)
                        agentData.phoneNumber = phoneNumber
                        await page.keyboard.press('Enter');
                        await sheet.addRow(agentData)
                        convArr.push(agentData)
                    } catch (error) {
