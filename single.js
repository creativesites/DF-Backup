...
async function run() {
    ...
    try {
        ...
        const url1 = 'https://dialogflow.cloud.google.com/#/agent/autoservice-gsiwft/history';
        ...
        // await page1.waitForTimeout(45000);
        ...
        // await selNum.click();
        // await page1.waitForTimeout(1000);
        // await page1.waitForSelector('#select_option_46')
        // await page1.waitForTimeout(1000);
        // await page1.click('#select_option_46');
        // await page1.waitForTimeout(25000);
        //5 
        let convArr = [];
        async function runBackup() {
            let iid = 200
            let agent = '00-005-LtoyoBellR-8184939734';
            convArr = []
            let oj = {
                USER: agent
            }                        
            ...
            async function getC(){
                for (let idx = 1; idx < iid; idx++) {
                    ...
                    if(idx === 101){
                        myIdx = myIdx - 100;
                        let bhn = await page1.waitForSelector('#main > div > div.workplace.ng-scope > div > history > div > div.navigation-panel.ng-scope.layout-align-end-center.layout-row > div.page-nav-buttons.unselectable > md-icon.next.material-icons');
                        await page1.waitForTimeout(1000);
                        await bhn.click();
                        await page1.waitForTimeout(15000);
                    }
                 ...
                 let agentSayArr = []
                 let convTime = []
                    let cpy = await page1.waitForSelector(`#main > div > div.workplace.ng-scope > div > history > div > div.content-section.ng-scope > conversations > div > div:nth-child(${myIdx}) > div`)
                    await page1.waitForTimeout(1000)
                    await scrollIntoViewIfNeeded(cpy, 6000);
                    await page1.click(`#main > div > div.workplace.ng-scope > div > history > div > div.content-section.ng-scope > conversations > div > div:nth-child(${myIdx}) > div`)
        ...
        async function pushData(){
            ...
            var config = {
                method: 'post',
                url: 'https://script.google.com/macros/s/AKfycbw9OYAd3AQd4IBPBjpWovKVbUJwUrnnUSmAZlNNAGwNbaCgMKODo9iFAN_AADMAUZvh/exec?gid=516734034',
                headers: {
