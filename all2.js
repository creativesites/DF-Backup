...
//let changeAgents1 = ['00-005-LtoyoBellR-8184939734', '00-002-CfordNapa-8184929153', '00-003-XhondTaz-8184929306',];
let changeAgents1 = [ '300-AutoPorX-816-281-6544', '330-SansKia_-818-493-9849', '331-SansMits-818-493-9971', '332-SansNiss-818-493-9961', '371-EnviHondV2-854-999-5365', '00-001-MkiaHambra-3238142465', '380-RegaNiss-BDC-8323088796'];
                      ...
                      for (let idx = 1; idx < iid; idx++) {
                       ...
                       let onh = {}
                          ...
                          userSayArr.map((el, idx3)=>{
                            ...
                            let key2 = 'AGENT' + idx3
                            let key3 = 'TIME' + idx3
                            let key4 = 'CHATBOT' + idx3
                            
                            onh[key1] = el;
                            onh[key2] = agentSayArr[idx3];
                            onh[key3] = convTime[idx3];
                            onh.CHATBOT = agent;
                            //convArr.push(onh);
