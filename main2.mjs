...
try {
    mongoose.connect('mongodb://localhost:27017/dfhist', {
                          ...
                          if(before === false || after === false){
                           ...
                           if(idx > 401 && idx < 501){
                            ...
                            // if(arrVal === 1 ||arrVal === 2){
                                ...
                                console.log(dd.customerPhone2)
                                let pnum = dd.customerPhone2
                                let smsnum = dd.smsPhoneNumber
                                let nam = dd.customerName
                                // let whkUsed = ''
                                // if(dd.webhookStatus.webhookUsed != undefined){
                                //     whkUsed = dd.webhookStatus.webhookUsed
                                // }
                                //let wbhkS = dd.webhookStatus.webhookStatus.message
                                // if(whkUsed){
                                //     wbhkS = dd.webhookStatus.webhookStatus.message
                                // }
                                //let isFallback = dd.intent.isFallback
                                //let intent = dd.intent.displayName
                                //let action = dd.action
