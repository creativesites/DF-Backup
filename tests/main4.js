...
//let changeAgents1 = ['410-StocHyun-8549995374', '371-EnviHondV2-854-999-5365','300-AutoPorX-816-281-6544', '00-005-LtoyoBellR-8184939734', '00-002-CfordNapa-8184929153', '00-003-XhondTaz-8184929306', '330-SansKia_-818-493-9849', '331-SansMits-818-493-9971', '332-SansNiss-818-493-9961',  '00-001-MkiaHambra-3238142465', '380-RegaNiss-BDC-8323088796', '00-004-NhondSerra__-7072421465', '00-006-XhondGalp-6174025457', '300-AutoPorsBell-8162816544', '301-AutoMercBell-3602271073', '342-HansBwm-B+R-8603176527', '343-HansVolk-B+R-8549995347', '372-EnviToyo-BDC-8592036683'];
...
let startDate = '2022-09-12'
let endDate = '2022-09-15'
...
async function run() {
    ...
    try {
                  ...
                  convArr.push(oj)
                    ...
                    try {
                        ...
                        async function getC(){
                          ...
                          console.log(dtToday)
                          console.log(dtOl1)
                          let date11 = new Date(dtToday);
                          let date23 = new Date(dtOl1);
                          
                          const result = datetimeDifference(date11, date23); 
                           ...
                           if(before === false || after === false){
                            ...
                            if(idx > 401 && idx < 501){
                             ...
                             // if(arrVal === 1 ||arrVal === 2){
                                 ...
                                 let pnum = ''
                                 try {
                                     if(dd?.customerPhone2 !== undefined){
                                         pnum = dd.customerPhone2
                                     }
                                 } catch (error) {
                                 ...
                                 let smsnum = ''
                                 try {
                                     if(dd?.smsPhoneNumber !== undefined){
                                         smsnum = dd.smsPhoneNumber
                                     }
                                 } catch (error) {
                                 ...
                                 // if(dd?.webhookStatus.webhookUsed !== undefined){
                                 //     whkUsed = dd.webhookStatus.webhookUsed
                                 // }
                                 let wbhkS = ''
                                 try {
                                     if(dd?.webhookStatus.webhookStatus.message !== undefined){
                                         wbhkS = dd.webhookStatus.webhookStatus.message
                                     } 
                                 } catch (error) {
                                 ...
                                 try {
                                     if(dd.intent.isFallback !== undefined){
                                         isFallback = dd.intent.isFallback
                                     }
                                 } catch (error) {
                                 ...
                                 let intent = ''
                                 try {
                                     if(dd?.intent.displayName !== undefined){
                                         intent = dd.intent.displayName
                                     } 
                                 } catch (error) {
                                 ...
                                 await page1.waitForTimeout(2000);
                              await page1.waitForSelector('aria/CLOSE')
                               await page1.click('aria/CLOSE')
                             ...
                             //   onh.SMSNumber = smsnum;
                             //   onh.PhoneNumber = pnum;
                             //   onh.CustomerName = nam;
                               onh.TrainingString = TrainingString;
                               //onh.WebhookObject = dd;
                               onh.Type = type;
                               //onh.WebhookUsed = whkUsed;
                               //onh.WebhookStatus = wbhkS;
                             //   onh.isFallback = isFallback;
                             //   onh.Action = action;
                             //   onh.Intent = intent;
        ...
        async function pushData(){
            ...
            var config = {
                method: 'post',
                url: 'https://script.google.com/macros/s/AKfycbw9OYAd3AQd4IBPBjpWovKVbUJwUrnnUSmAZlNNAGwNbaCgMKODo9iFAN_AADMAUZvh/exec?gid=1043685445',
                headers: {
